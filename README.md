...
对比：（dirsearch没有进行对页面的判断，302,400,500，无效的页面会直接显示）

![image-20230309112110394](image//image-20230309112110394.png)

![image-20230309112127296](image//image-20230309112127296.png)
